...
class Turmas(models.Model):
    ...
    itinerario = models.CharField(max_length=2, choices=ITINERARIO_CHOICES, verbose_name="Itinerario")
    turma = models.CharField(max_length=2, choices=TURMAS_CHOICES, verbose_name="Turma")
...
class ResponsavelAluno(models.Model):
    ...
    classes_filhos = models.CharField(max_length=2, choices=TURMAS_CHOICES)
    

    def __str__(self):
        return self.name_responsavel
...
class Aluno(models.Model):
    ...
    def __str__(self):
        return f"{self.name_aluno} - {self.class_aluno}"
...
class Professor(models.Model):
    ...
    classes = models.CharField(max_length=2, choices=TURMAS_CHOICES)
